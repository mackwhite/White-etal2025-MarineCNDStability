...
###author(s): MW, NL, & WRJ
###goal(s): Visualizing full term model best fit for within-ecosystem driver
## of CND stability
...
mean(post$`r_Program[MCR,synch]`+ post$b_synch < 0)
mean(post$`r_Program[MCR,troph_beta_time]`+ post$b_troph_beta_time < 0)
...
mean(post$`r_Program[PCCS,synch]`+ post$b_synch < 0)
...
mean(post$`r_Program[FCE,synch]`+ post$b_synch < 0)
mean(post$`r_Program[FCE,troph_beta_time]`+ post$b_troph_beta_time < 0)
...
mean(post$`r_Program[PCCC,troph_beta_time]`+ post$b_troph_beta_time < 0)
...
# ggsave('output/figs/fig4.png', plot = f4, dpi = 600, units= 'in', height = 7.5, width = 5.75)