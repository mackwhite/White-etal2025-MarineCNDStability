...
mod_output <- dat |>
      ...
      group_by(Program) |>
      mutate(across(comm_mean_max_ss:troph_synch, \(x) as.numeric(scale(x, center = TRUE)))) |>
      ungroup()

write_csv(mod_output,'local_data/path-model-data.csv')
...
write_csv(model_selection, "output/tables/april-brm-fullmodel-selection-table-roundone.csv")
...
write_csv(model_selection, "output/tables/april-brm-fullmodel-selection-table-roundtwo.csv")
...
write_csv(model_selection_full, "output/tables/april-brm-fullmodel-selection-table-roundthree.csv")
...
write_csv(model_selection_full, "output/tables/april-brm-fullmodel-selection-table-roundfour.csv")
full_model <- m4705
