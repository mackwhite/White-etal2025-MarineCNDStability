...
###########################################################################
###########################################################################
# Population Level CND Synchrony and Turnover Calculations ----------------
###########################################################################
###########################################################################
###########################################################################
...
habitat_mapping <- data.frame(
      ...
      Habitat = c(
            ...
            "Reference", "Marine Protected Area", #PISCO-Central, PISCO-South, & SBC-Ocean
            "Seagrass", "Sand")) #VCR
...
keep <- c("species_presence", "dat_ready_4")
...
###########################################################################
###########################################################################
# Trophic Level CND Synchrony and Turnover Calculations -------------------
###########################################################################
###########################################################################
###########################################################################
...
### clean up environment
keep <- c("trophic_presence", "dat_ready_4")
rm(list = setdiff(ls(), keep))
